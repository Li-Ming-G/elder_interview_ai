...
- `READY`: `CKPT-A-LEGACY-PREPARE-BRIDGE-01`.
- `IN_PROGRESS`: none.
- `REVIEW`: none.
...
Persistent Dispatcher fresh-reads `origin/main`, selects the unique eligible READY task `CKPT-A-LEGACY-PREPARE-BRIDGE-01`, persists READY -> IN_PROGRESS, and launches its declared luna-high IMPLEMENTATION_WORKER. External Architect reviews the exact PR head after implementation CI succeeds.
