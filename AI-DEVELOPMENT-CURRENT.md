...
`DISPATCHER-STALE-DONE-RECONCILIATION-01` is `IN_PROGRESS` for bounded same-PR repair on PR #121 at head `6ddde4578e87c069d2224b9a918992944b398b95`; exact-head CI failed only at `test:e2e:auth`, and the task has priority by explicit Product Owner decision.
