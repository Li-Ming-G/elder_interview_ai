...
`PFC-01-NEW-INTENT-TRUTH` is `REVIEW` on PR #127 at repaired exact head `6b38d1272f46ef565f3317943455c28926fd164b`. Exact-head required CI run `33485521255` attempt 2 succeeded, and the prior-head `REQUEST_CHANGES` verdict is stale.
...
Dispatcher reconciled repaired head `6b38d1272f46ef565f3317943455c28926fd164b` with exact-head required CI success, persisted `IN_PROGRESS -> REVIEW`, and is publishing refreshed external Architect review context.
