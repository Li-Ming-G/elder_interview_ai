...
- `IN_PROGRESS`: none.
- `REVIEW`: none.
- `BLOCKED`: `CKPT-A-WEB-CWD-01` / `MAIN_VERIFY_FAILED` on main `3ce74646b0070c044a1cfec72950170d3f3c6561`, CI run `33297492383`.
...
Persistent Dispatcher reconciled PR #125 at exact head `60cdce838394467379254890d3b2536cca3383c6` as merged and found it in refreshed current main `3ce74646b0070c044a1cfec72950170d3f3c6561`. Exact-current-main CI run `33297492383` failed, so the task is `BLOCKED / MAIN_VERIFY_FAILED`; later pulse recovery is required before DONE synchronization.
