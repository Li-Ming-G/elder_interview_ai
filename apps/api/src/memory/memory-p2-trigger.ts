...
function assertTriggerRequest(request: MemoryP2TriggerRequest): void {
  if (!isP1V12(request.p1SourceContractVersion)) throw new Error('P2_P1_SOURCE_VERSION_INVALID');
...
function isP1V12(value: string): boolean {
  return value === MEMORY_P2_SOURCE_CONTRACT_VERSION;
}
