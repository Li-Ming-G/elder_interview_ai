...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.26；`05` §3.5；`06` §9-11；ADR-020/021/022 | 首次访谈准备页、转录优先工作台、链路状态和安全结束；项目管理/完整回顾后置 | `DEV-005A/B/C` 已实现并通过；`DISC-005D` 讨论产品体验；`DEV-005D` 待实现 | stop/recover、统一 snapshot、ASR ending 与 finalization single-flight 已成为服务端事实；讨论先冻结等待/离开和终态去向，页面再做薄消费 | `09` 场景 A/C、§10.1；并发锁、drain、终态/幂等及 single-flight PostgreSQL 测试；DISC-005D 可观察体验场景待验收 | REV-018/019 PASS；DISC-005D READY，DEV-005D 等待讨论验收 | 执行中 |
