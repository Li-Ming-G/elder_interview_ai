...
| REQ-004 | `01` §8；`03` §7-12、§18；ADR-020/021 | 首次访谈准备页、转录优先工作台、链路状态和安全结束；项目管理/完整回顾后置 | `DEV-005A/B/C/D`（未实现） | 准备/start 与实时 seam 已存在；stop/recover 由 SPEC-SESSION-END-001 冻结后交 DEV-005C/005D | `09` 场景 A/C | SPEC-FE-001 首轮 NEEDS_CHANGES；CON-019 已登记 | 规划 |
...
| REQ-012 | `00` §3、§9；`09` §1.1；`10` §1.1；ADR-013/020/021 | 探索期以虚构数据分段建立纵向链路，当前优先首次访谈三页闭环；任务 DONE 与真实试点分层门禁 | `MVP-V01`、`DEV-002/003/004/005/006/007` | 复用已冻结 REST/事件契约；stop/recover 未冻结前不视为可用；测试转录和预创建项目仅内部夹具 | 首次访谈 Chromium 纵向 E2E；真实试点仍执行 `09` §13 | SPEC-FE-001 针对安全结束依赖修订中 | 执行中 |
