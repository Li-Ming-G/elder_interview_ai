...
| REQ-003 | `01` §6；`04` §4.7/4.9；`06` §4-10；ADR-006/018 | 实时 ASR、确定态转录与说话人映射 | DEV-004A final-only 存储核心候选 `f80c4c3`；DEV-004B/C 待拆契约 | `05` §3.7、§5；DEV-004A 不开放写 API/WS | 本地 final/interim/payload/fixture/受限查询单元验证 63/63；PostgreSQL 集成待 CI；后续实时 E2E | iteration-coach Correction mode；DEV-004A 等待 GitHub 项目负责人审查 | IN_PROGRESS |
