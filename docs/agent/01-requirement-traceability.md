...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.26；`05` §3.5；`06` §9-11；ADR-020/021/022 | 首次访谈准备页、转录优先工作台、链路状态和安全结束；项目管理/完整回顾后置 | DEV-005A 已实现；DEV-005C 候选实现 stop/recover、audio/realtime seam 与 migration `20260807190000_session_finalization`；DEV-005B/D 待实现 | 公共 session snapshot、stop/recover、冻结 commitments、受限 evidence-finalization | DEV-005C unit、PostgreSQL integration、auth、migration、build/smoke 本地 PASS；最终数字以 PR head 为准 | REV-016/017 PASS；DEV-005C 当前 REVIEW，尚无项目负责人实现 PASS；DEV-005D 继续 BLOCKED | 执行中 |
...
| REQ-012 | `00` §3、§9；`09` §1.1；`10` §1.1；ADR-013/020/021 | 探索期以虚构数据分段建立纵向链路，当前优先首次访谈三页闭环；任务 DONE 与真实试点分层门禁 | `MVP-V01`、`DEV-002/003/004/005/006/007` | 复用已冻结 REST/事件契约；stop/recover 未冻结前不视为可用；测试转录和预创建项目仅内部夹具 | 首次访谈 Chromium 纵向 E2E；真实试点仍执行 `09` §13 | DEV-005A 已 PASS/DONE，DEV-005B READY；完整闭环仍受安全结束子链约束 | 执行中 |
