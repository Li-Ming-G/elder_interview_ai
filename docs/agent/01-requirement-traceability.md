...
| REQ-005 | `01` §5.7-5.8、§6、§9；`04` §§4.28-4.43；`05` §§3.9-3.10；`07` §§3-5/§9/§12-15；ADR-026/027 | 后台 current memory 改善当前下一问与第二次开场；自动记忆直接使用但保留 evidence/version；冲突澄清、明确更正、快照/未来资格/visibility、会后实际问题与完整过程记录 | DEV-004/C1/C2、DISC-006、SPEC-DEV-006 DONE；`DEV-006` READY | C 生产 trusted role/revision/membership；SPEC 冻结逐业务输出 derived 一对一、整版 actual catalog、dependency manifest、三类 retention root、QuestionEvidenceModule、两阶段并发、删除与 legacy 默认；DEV-006 按 final contract 实现 | `09` §4、§6.1、§7.4-7.5、§8.2、场景 B；final head `4759633`、CI `31326717132`、REV-031 PASS、merge `6289c87` | CON-024 RESOLVED；CON-018/023 继续 OPEN。普通修正保留快照，硬边界撤下正文；删除 runtime 仍不得伪报覆盖 | READY |
| REQ-006 | `01` §6、§9；`03` §9.3；`04` §4.36-4.41；`05` §3.9；`07` §6-13；ADR-020/024/027/028 | 单个当前最佳追问、推荐原因、继续倾听；更合适问题自动替换；“上一个问题/回到当前问题”浏览展示历史；“下一个问题”主动请求；边界与降级 | `DISC-AI-QUESTION-001` DONE；`SPEC-AI-QUESTION-001` READY；`DEV-007A` 未实现 | `SPEC-AI-QUESTION-001` 冻结自动替换稳定规则、手动请求幂等、历史游标/安全投影、节流、相似度与 REST/WS；共享 QuestionEvidence seam 已由 SPEC-DEV-006 提供 | `09` 场景 A、§12.1、缺陷分级 | 不恢复采用/已问/忽略；展示历史不等于实际问过；硬边界撤下正文后历史也不得回流 | READY |
