...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.27；`05` §3.5；`06` §3/§9-11；`08` §4.5；`09` §10.2/场景 A；ADR-020-024 | 首次访谈准备、真实单流录音与本浏览器 archive、实时转录、中断恢复、安全收束和事实展示；Android Chrome 为完整主设备，iPhone Safari 延期；项目管理/完整回顾后置 | `SPEC-DEV-005R`、`DEV-005R1`、`DEV-005R2C`、`DEV-005R2` 已 DONE；`DEV-005R3` 已交 GitHub REVIEW，`DEV-005R4` 等待 R3 PASS | 原子 start、capture generation、同一 audio object、archive/delivery 分离、controller 完整事实 projection、既有 stop/finalize/recover/abandon | R3 unit 纳入全量 32 files / 197 tests；PostgreSQL integration 41、auth 13、普通 Chromium 8/8、auth Chromium 4/4；五视口 × recording/interrupted/stopping/processing/completed/failed/NO_AUDIO 共 35 张截图与尺寸断言；R2 Android 事实见 REV-024，R3 未冒充真机 R4 | R3 实现候选等待项目负责人 GitHub final head PASS；CON-020/021 继续开放到 R4 完整恢复/安全结束，CON-022 保持开放等待 Android 复验，父 DEV-005 仍执行中 | 执行中 |
