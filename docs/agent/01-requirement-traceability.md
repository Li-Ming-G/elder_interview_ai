...
| REQ-003 | `01` §6；`04` §4.7/4.9；`05` §5；`06` §4-10；ADR-006/018/019 | 实时 ASR、确定态转录与说话人映射 | DEV-004A/B1 已合并；DEV-004B2 候选 `87dd225` + `ce67549` 已进入 REVIEW；C 待后续 | B1 静态 `/ws/interviews`、join/PCM/ACK/恢复正式契约；B2 独立 browser transport/harness 消费同一 wire contract，无公开文字注入 | A/B1 最终 CI PASS；B2 本地 format/lint/typecheck/build、unit 103、普通 Chromium 4/4；PostgreSQL/migration/auth/smoke/auth Chromium 待 CI | REV-012/013 PASS；REV-014 PENDING；父 DEV-004 保持开放 | IN_PROGRESS |
