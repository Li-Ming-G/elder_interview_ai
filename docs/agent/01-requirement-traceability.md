...
| REQ-002 | `01` §6；`04` §4.8/§4.24；`06` §2-3；ADR-016 | 原始录音、授权/访谈用途隔离、分片幂等、连续性与恢复 | `apps/web/src/audio`；`apps/api/src/audio`；Prisma migration `20260804120000_audio_objects` | `05` §3.6、§4 的 audio object init/raw upload/complete/manifest | unit 11 files/48 tests；Chromium 2/2；GitHub CI `30872055084` 的 migration/integration/auth/E2E 全通过 | CON-010 RESOLVED；DEV-003A/B 均 REVIEW；GitHub PR #1 等项目负责人按 commit 审查 | IN_PROGRESS |
