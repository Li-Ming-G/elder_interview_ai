...
| REQ-003 | `01` §5.7、§6；`03` §8、§12、§15；`04` §4.6A-4.9D；`05` §3.7、§5；`06` §4-10；ADR-006/018/019/025 | 实时 ASR、确定态转录、流级说话人确认、可信角色与人工修正 | DEV-004A/B1/B2 已合并；`SPEC-DEV-004C` DONE；`DEV-004C1` READY、`DEV-004C2` BLOCKED | B1/B2 既有 `/ws/interviews`；正式新增 `speaker_stream_id`、PCM 串行 marker 的不可变 calibration window、统一 snapshot、单段与持久闭区间批量修正、revision/membership seam | 既有 B2 head `73a07cb` PASS；C1/C2 按 `09` delayed final、snapshot、流隔离、消费门禁、原子修正和 Android 矩阵待执行 | REV-027 定向复审对 PR #17 head `2a65b1f` PASS，CI `31298277051`、merge `0b6c357`；CON-014 RESOLVED | IN_PROGRESS |
