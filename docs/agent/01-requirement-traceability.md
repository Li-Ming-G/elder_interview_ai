...
| REQ-004 | `01` §8；`03` §7-12、§18；ADR-020 | 首次访谈准备页、转录优先工作台、链路状态和安全结束；项目管理/完整回顾后置 | `DEV-005A/B`（未实现） | 复用 `05` §3.5、§5；建议卡由 DEV-007A 接入 | `09` 场景 A/C | SPEC-FE-001 待 GitHub 审查 | 规划 |
...
| REQ-012 | `00` §3、§9；`09` §1.1；`10` §1.1；ADR-013/020 | 探索期以虚构数据分段建立纵向链路，当前优先首次访谈三页闭环；任务 DONE 与真实试点分层门禁 | `MVP-V01`、`DEV-002/003/004/005/006/007` | 复用正式 REST/事件契约；测试转录和预创建项目仅内部夹具 | 首次访谈 Chromium 纵向 E2E；真实试点仍执行 `09` §13 | 页面规划进入 SPEC-FE-001 REVIEW | 执行中 |
