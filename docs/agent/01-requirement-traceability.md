...
| REQ-003 | `01` §5.7、§6；`03` §8、§12、§15；`04` §4.6A-4.9D；`05` §3.7、§5；`06` §4-10；ADR-006/018/019/025 | 实时 ASR、确定态转录、流级说话人确认、可信角色与人工修正 | DEV-004A/B1/B2 已合并；`SPEC-DEV-004C` DONE；`DEV-004C1` REVIEW、`DEV-004C2` BLOCKED | B1/B2 既有 `/ws/interviews`；C1 候选新增持久 `speaker_stream_id`、PCM 串行 marker 的不可变 calibration window、统一 snapshot、revision/membership seam；单段与持久闭区间批量修正仍归 C2 | C1 unit 214、PostgreSQL integration 48、auth 13、普通 Chromium 8、auth Chromium 4 均通过；空库和旧 DEV-004A/B 升级通过；Android 真机无当前 ADB/CDP 证据，保持 REVIEW | REV-027 对 SPEC PR #17 PASS；C1 非 Draft PR #18 等待项目负责人 exact-head 手动 GitHub 审查；CON-014 保持 RESOLVED | IN_PROGRESS |
