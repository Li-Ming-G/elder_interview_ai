...
| REQ-003 | `01` §5.7、§6；`03` §8、§12、§15；`04` §4.6A-4.9D；`05` §3.7、§5；`06` §4-10；ADR-006/018/019/025 | 实时 ASR、确定态转录、流级说话人确认、可信角色与人工修正 | DEV-004A/B1/B2/C1 已合并；`SPEC-DEV-004C` DONE；`DEV-004C2` REVIEW | C1 stable transcript/trusted-role/calibration seam；C2 新增单段修正、持久闭区间 preview/完整 membership、原子 execute、operation/session revision/脱敏审计与工作台行内单段 UI；不实现 AI consumer | 本地 unit 223、PostgreSQL integration 57（其中 C2 8）、Chromium 9、空库与 C1 fixture 升级通过；完整 GitHub CI 待 PR final head。project restricted/deleted 已测；deletion scope `NOT IMPLEMENTED / NOT VERIFIED`，CON-023 OPEN，相关 `09` 项不列 PASS | C2 仅提交“当前尚无 deletion producer 的内部 MVP 角色修正核心”REVIEW 候选；复杂批量 UI、AI stale/recompute、完整删除安全链路均未完成；父 DEV-004 继续 IN_PROGRESS | REVIEW |
...
| REQ-005 | `01` §5.7、§6、§9；`07` §3-5 | 项目级结构化记忆、证据回链与冲突处理；只消费可信 elder/interviewer，排除 unknown 与校准控制内容 | `DEV-004C1` PASS；`SPEC-DEV-006`、`DEV-006` 尚未实现 | `05` §3.7、§3.10；C 生产 session revision/membership；SPEC-DEV-006 冻结逐 session watermark、跨 session provenance、输出 stale/查询过滤；DEV-006 负责重算 | `09` §4、§6.1、§7、场景 B | C1 技术前置已满足；SPEC-DEV-006 仍等待专项产品讨论，项目负责人 PASS 前 DEV-006 不得开工 | 规划 |
