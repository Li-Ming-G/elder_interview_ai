...
|---|---|---|---|---|---|---|---|
| REQ-001 | `01` §6、§9；`03` §4-6；`08` §4-5 | 项目、服务条款、授权与访问门禁 | `DEV-002`（未实现） | `05` §3.1-3.5 | `09` §4、§8、场景 A/D | 待执行 | 规划 |
| REQ-002 | `01` §6；`06` §2-3 | 原始录音、分片幂等、连续性与恢复 | `DEV-003`（未实现） | `05` §3.6、§4 | `09` §6、场景 C | 待执行 | 规划 |
...
| REQ-009 | `02` §3；`ADR-007`、`ADR-008`、`ADR-010` | 可重复 workspace、PostgreSQL 迁移、统一测试和 CI 根门禁 | `DEV-001A`（READY） | 健康检查与公共错误外壳 | `DEV-001A` 任务卡验证命令 | REV-003 PASS，允许实现 | 已定义 |
