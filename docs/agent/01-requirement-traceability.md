...
| REQ-003 | `01` §5.7、§6；`03` §8、§12、§15；`04` §4.6A-4.9D；`05` §3.7、§5；`06` §4-10；ADR-006/018/019/025 | 实时 ASR、确定态转录、流级说话人确认、可信角色与人工修正 | DEV-004A/B1/B2/C1/C2 与 `SPEC-DEV-004C` 已合并 | C1 stable transcript/trusted-role/calibration seam；C2 新增单段修正、持久闭区间 preview/完整 membership、原子 execute、operation/session revision/脱敏审计与工作台行内单段 UI；不实现 AI consumer | PR #19 final head `757bf52`、CI `31310993567` 全门禁 PASS、REV-029 PASS、merge `83cdfef`；unit 225、PostgreSQL integration 57、Chromium 9。project restricted/deleted 已测；deletion scope `NOT IMPLEMENTED / NOT VERIFIED`，CON-023 OPEN，相关 `09` 项不列 PASS | C2 当前内部 MVP 修正核心 DONE；复杂批量 UI、AI stale/recompute、完整删除安全链路与父 DEV-004 的缺失区间/补转录收口仍未完成 | IN_PROGRESS |
