...
| REQ-006 | `01` §6、§9；`03` §9.3；`07` §6-13；ADR-020/024/027 | 单个当前最佳追问、推荐原因、继续倾听、“没用，换一个”、只撤销最近一次更换、边界与降级 | `DISC-AI-QUESTION-001` IN_PROGRESS；`SPEC-AI-QUESTION-001` BLOCKED；`DEV-007A` 未实现 | 先冻结自动更新、连续换题、无合格新问题和撤销窗口；再由 `05` §3.9/§5.10 冻结 replace/undo 幂等、竞态、节流、相似度与 REST/WS；共享 seam 已由 SPEC-DEV-006 提供 | `09` §7、场景 A/B/C | 不恢复采用/已问/忽略；讨论不重开记忆、actual-question、retention 或安全边界 | 讨论中 |
