...
| REQ-003 | `01` §5.7、§6；`03` §8、§12、§15；`04` §4.6A-4.9D；`05` §3.7、§5；`06` §4-10；ADR-006/018/019/025 | 实时 ASR、确定态转录、流级说话人确认、可信角色与人工修正 | DEV-004A/B1/B2/C1 已合并；`SPEC-DEV-004C` DONE；`DEV-004C2` READY | B1/B2 既有 `/ws/interviews`；C1 已交付 stable `(start_ms,id)` transcript API、GET/WS 共用 trusted-role projection、marker 后 canonical event 队列线性化与 membership 时间语义；单段与持久闭区间批量修正仍归 C2 | REV-028 定向复审绑定 head `a984587e86ba7824c789dad2fe0e2fa847abbd3d`：相关 unit 27/27、Chromium 小屏 1/1 独立复跑通过，CI `31305357363` 完整门禁 PASS；Android 真机不在本轮要求 | PR #18 merge `99b090d`，C1 DONE；C2 READY；父 DEV-004 继续 IN_PROGRESS | IN_PROGRESS |
