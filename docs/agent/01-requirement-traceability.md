...
| REQ-003 | `01` §6；`04` §4.7/4.9；`05` §5；`06` §4-10；ADR-006/018/019 | 实时 ASR、确定态转录与说话人映射 | DEV-004A 已合并；DEV-004B1 服务端实时协议 READY；B2/C 待后续 | B1 静态 `/ws/interviews`、join/PCM/ACK/恢复正式契约；无公开文字注入 | A：最终 CI `30887031030` PASS；B1 待 WS unit/integration/PostgreSQL；B2 待 Chromium 实时 E2E | REV-012 PASS；iteration-coach 对 B 拆 B1/B2；B1 READY | IN_PROGRESS |
