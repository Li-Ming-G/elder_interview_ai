...
| REQ-003 | `01` §6；`04` §4.7/4.9；`06` §4-10；ADR-006/018 | 实时 ASR、确定态转录与说话人映射 | DEV-004A final-only 存储核心已合并；DEV-004B/C 待正式任务卡 | `05` §3.7、§5；DEV-004A 不开放写 API/WS | 本地 unit 63/63；最终 head CI `30887031030` 的 migration/integration/auth/smoke/E2E 全门禁 PASS；后续实时 E2E | REV-012 对 PR #3 head `917f888` PASS；merge `2098d9f`；父 DEV-004 保持 IN_PROGRESS | IN_PROGRESS |
