...
| REQ-005 | `01` §5.7-5.8、§6、§9；`07` §3-5/§9/§12-15；ADR-026 | 后台 current memory 改善当前下一问与第二次开场；自动记忆直接使用但保留 evidence/version；冲突澄清、明确更正、快照/未来资格、会后实际问题与完整过程记录 | DEV-004/C1/C2、DISC-006 DONE；`SPEC-DEV-006` READY；`DEV-006` BLOCKED | C 生产 trusted role/revision/membership；SPEC 冻结跨 session watermark、job/segment/output provenance、current memory、displayed snapshot/future eligibility、actual asked、过程记录与删除；DEV-006 实现 | `09` §4、§6.1、§7.4、§8.2、场景 B | CON-024 RESOLVED：普通修正保留快照、硬边界撤下正文；补转录不是前置。SPEC 项目负责人 PASS 前 DEV-006 不得开工 | 规划 |
