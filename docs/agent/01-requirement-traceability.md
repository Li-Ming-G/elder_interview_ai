...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.27；`05` §3.5；`06` §3/§9-11；`08` §4.5；`09` §10.2/场景 A；ADR-020-024 | 首次访谈准备、真实单流录音与本浏览器 archive、实时转录、中断恢复、安全收束和事实展示；Android Chrome 为完整主设备，iPhone Safari 延期；项目管理/完整回顾后置 | `DEV-005A/B/C` 为历史已通过切片；`SPEC-DEV-005R` 冻结新链路；`DEV-005R1/2/3/4` 实现与验收 | 原子 start、capture generation、同一 audio object、archive/delivery 分离、统一 snapshot、既有 finalization | R1 原 head CI `31239385749` 完整 verify PASS；REV-021 发现全 generation PCM 证据缺口并进入定向修复；后续仍需桌面 Chromium + Android Chrome 真机 5–10 分钟、五视口及故障矩阵 | REV-021：SPEC 首轮 REQUEST_CHANGES，4 个 P1 已写回候选；R1 REV-020 被其中一项部分 supersede，等待双定向复审；CON-020/021 继续开放 | 执行中 |
