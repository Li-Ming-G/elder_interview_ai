...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.27；`05` §3.5；`06` §3/§9-11；`08` §4.5；`09` §10.2/场景 A；ADR-020-024 | 首次访谈准备、真实单流录音与本浏览器 archive、实时转录、中断恢复、安全收束和事实展示；Android Chrome 为完整主设备，iPhone Safari 延期；项目管理/完整回顾后置 | `SPEC-DEV-005R`、`DEV-005R1`、`DEV-005R2C`、`DEV-005R2`、`DEV-005R3` 已 DONE；`DEV-005R4` 候选进入 REVIEW | 原子 start、capture generation、同一 audio object、archive/delivery 分离、controller 完整事实 projection、既有 stop/finalize/recover/abandon；R4 最小修复在服务端可信边界应用恢复代 ASR timeline offset，不改变 wire PCM 或公共契约 | R3/REV-025 既有证据；R4 桌面 Chromium 151 5 分钟正式路由、OnePlus GM1900 / Android 12 / Chrome 150 约 8分21秒正式路由；Android 同 session/object/job、generation `0→1`、archive `426→490`、offset/首个恢复代转录 `436604ms`、491/491 manifest、ASR drained、session completed；普通音量通过且安静失败 | R4 仅为 REVIEW 候选；CON-020/021/022 均保持 OPEN，父 DEV-005 继续 IN_PROGRESS，等待非 Draft PR final head CI 与项目负责人手动 GitHub 复核 | REVIEW |
