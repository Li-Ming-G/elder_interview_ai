...
| REQ-005 | `01` §5.7-5.8、§6、§9；`04` §§4.28-4.43；`05` §§3.9-3.10；`07` §§3-5/§9/§12-15；ADR-026/027 | 后台 current memory 改善当前下一问与第二次开场；自动记忆直接使用但保留 evidence/version；冲突澄清、明确更正、快照/未来资格/visibility、会后实际问题与完整过程记录 | DEV-004/C1/C2、DISC-006 DONE；`SPEC-DEV-006` REVIEW；`DEV-006` BLOCKED | C 生产 trusted role/revision/membership；SPEC 候选冻结跨 session scope+membership、claim/resolution、QuestionEvidenceModule、两阶段并发、删除与 legacy 默认；DEV-006 待 PASS 后实现 | `09` §4、§6.1、§7.4-7.5、§8.2、场景 B；SPEC PR exact head/CI 待最终交接绑定 | CON-024 RESOLVED；CON-018/023 继续 OPEN。普通修正保留快照，硬边界撤下正文；SPEC 项目负责人 PASS 前 DEV-006 不得开工 | REVIEW |
