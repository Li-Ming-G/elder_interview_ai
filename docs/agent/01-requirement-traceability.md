...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.26；`05` §3.5；`06` §9-11；ADR-020/021/022 | 首次访谈准备页、转录优先工作台、链路状态和安全结束；项目管理/完整回顾后置 | `DEV-005A/B/C/D`（未实现） | stop 冻结唯一录音对象/逐片 commitment；recover 读取持久 finalization；公共 session snapshot 提供时长、manifest 与转录终态 | `09` 场景 A/C、§10.1 安全结束矩阵 | REV-015 已 PASS；SPEC-SESSION-END-001 为 REVIEW 候选，CON-019 等待最终 head 审查 | 执行中 |
...
| REQ-012 | `00` §3、§9；`09` §1.1；`10` §1.1；ADR-013/020/021 | 探索期以虚构数据分段建立纵向链路，当前优先首次访谈三页闭环；任务 DONE 与真实试点分层门禁 | `MVP-V01`、`DEV-002/003/004/005/006/007` | 复用已冻结 REST/事件契约；stop/recover 未冻结前不视为可用；测试转录和预创建项目仅内部夹具 | 首次访谈 Chromium 纵向 E2E；真实试点仍执行 `09` §13 | SPEC-FE-001 已 PASS；DEV-005A READY，完整闭环仍受安全结束子链约束 | 执行中 |
