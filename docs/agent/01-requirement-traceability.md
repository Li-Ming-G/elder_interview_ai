...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.27；`05` §3.5；`06` §3/§9-11；`08` §4.5；`09` §10.2/场景 A；ADR-020-023 | 首次访谈准备、真实单流录音与本浏览器 archive、实时转录、中断恢复、安全收束和事实展示；项目管理/完整回顾后置 | `DEV-005A/B/C` 为历史已通过切片；`SPEC-DEV-005R` 冻结新链路；`DEV-005R1/2/3/4` 实现与验收 | 原子 start、capture generation、同一 audio object、archive/delivery 分离、统一 snapshot、既有 finalization | PostgreSQL 并发、真实 Chromium 5–10 分钟虚构内容、刷新/网络/撤权/设备/容量/结束矩阵 | REV-018/019 仅证明旧范围；SPEC-DEV-005R REVIEW，CON-020 等实现证据 | 执行中 |
