...
| REQ-006 | `01` §6、§9；`03` §9.3；`07` §6-13；ADR-020/024/027 | 单个当前最佳追问、推荐原因、继续倾听、“没用，换一个”、只撤销最近一次更换、边界与降级 | `SPEC-AI-QUESTION-001` READY、`DEV-007A`（未实现）；R3 只留状态容器 | `05` §3.9、§5.10；replace/undo 幂等、竞态和排除集合恢复待冻结；共享 question history/derived/retention seam 由 SPEC-DEV-006 提供 | `09` §7、场景 A/B/C | SPEC-DEV-006 已 PASS/merge；SPEC-AI 只补问题专项 seam，旧采用/已问/忽略动作继续冻结 | READY |
