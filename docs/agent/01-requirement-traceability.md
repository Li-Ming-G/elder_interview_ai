...
| REQ-003 | `01` §6；`04` §4.7/4.9；`05` §5；`06` §4-10；ADR-006/018/019 | 实时 ASR、确定态转录与说话人映射 | DEV-004A/B1 已合并；B2/C 待后续 | B1 静态 `/ws/interviews`、join/PCM/ACK/恢复正式契约；无公开文字注入 | A：CI `30887031030` PASS；B1：最终 head `80ff1c7`、CI `30969408276` 的 migration/WS+PostgreSQL/auth/smoke/E2E 全通过；B2 待 Chromium | REV-012/013 PASS；B1 merge `13350a4`；父 DEV-004 保持开放 | IN_PROGRESS |
