...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.27；`05` §3.5；`06` §3/§9-11；`08` §4.5；`09` §10.2/场景 A；ADR-020-024 | 首次访谈准备、真实单流录音与本浏览器 archive、实时转录、中断恢复、安全收束和事实展示；Android Chrome 为完整主设备，iPhone Safari 延期；项目管理/完整回顾后置 | `SPEC-DEV-005R` 与 `DEV-005R1` 已 DONE；`DEV-005R2C/2/3/4` 继续实现与验收 | 原子 start、capture generation、同一 audio object、archive/delivery 分离、统一 snapshot、既有 finalization | R1 final head `c19a295`、CI `31245403822`：unit 136、PostgreSQL integration 41、auth 13 及完整 verify PASS；后续仍需 R2C、桌面 Chromium + Android Chrome 真机 5–10 分钟、五视口及故障矩阵 | REV-020 定向复审 PASS，R1 merge `656db20`；CON-020/021 继续开放 | 执行中 |
