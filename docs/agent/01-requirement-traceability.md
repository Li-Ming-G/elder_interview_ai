...
| REQ-004 | `01` §8；`03` §7-12、§18；ADR-020/021 | 首次访谈准备页、转录优先工作台、链路状态和安全结束；项目管理/完整回顾后置 | `DEV-005A/B/C/D`（未实现） | 准备/start 与实时 seam 已存在；stop/recover 由 SPEC-SESSION-END-001 冻结后交 DEV-005C/005D | `09` 场景 A/C | REV-015 对 PR #6 head `47f7b35` PASS；页面规划 DONE，CON-019 仍 OPEN | 规划 |
