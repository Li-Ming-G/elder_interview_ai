...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.26；`05` §3.5；`06` §9-11；ADR-020/021/022 | 首次访谈准备页、转录优先工作台、链路状态和安全结束；项目管理/完整回顾后置 | `DEV-005A/B` 已实现；`DEV-005C` single-flight 修复候选完成，`DEV-005D` 待实现 | stop/recover、ASR ending 与按 finalization ID 的同进程 single-flight；持久 draining 保留重启重驱 | `09` 场景 A/C、§10.1；阻塞 adapter 并发 recover/reconcile/stop barrier 与失败清理重驱 | REV-019 第二轮对旧 head REQUEST_CHANGES；新候选本地完整门禁通过，等待第三次定向复审；DEV-005D 继续等待 C PASS | 执行中 |
