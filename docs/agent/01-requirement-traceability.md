...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.26；`05` §3.5；`06` §9-11；ADR-020/021/022 | 首次访谈准备页、转录优先工作台、链路状态和安全结束；项目管理/完整回顾后置 | `DEV-005A/B` 已实现；`DEV-005C` 定向修复中，`DEV-005D` 待实现 | 正式深链、准备/start 与实时工作台已存在；stop/recover 实现候选仍需关闭锁、ASR drain、重启事实和幂等 P1 | `09` 场景 A/C、§10.1 安全结束矩阵 | REV-018 对 PR #9 PASS；REV-019 对 PR #10 head `738898a` REQUEST_CHANGES，P1=4；DEV-005D 继续等待 C PASS | 执行中 |
