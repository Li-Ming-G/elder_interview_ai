...
| REQ-003 | `01` §6；`04` §4.7/4.9；`06` §4-10；ADR-006/018 | 实时 ASR、确定态转录与说话人映射 | DEV-004A final-only 存储核心待实现；DEV-004B/C 待拆契约 | `05` §3.7、§5；DEV-004A 不开放写 API/WS | DEV-004A：final 幂等/冲突、interim 不落库、原文原角色保留、故障隔离；后续实时 E2E | iteration-coach Correction mode；DEV-004A READY | IN_PROGRESS |
