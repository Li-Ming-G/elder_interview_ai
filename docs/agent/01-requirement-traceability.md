...
| REQ-004 | `01` §8；`03` §7-12、§17.2/§18；`04` §4.6/§4.25-4.27；`05` §3.5；`06` §3/§9-11；`08` §4.5；`09` §10.2/场景 A；ADR-020-024 | 首次访谈准备、真实单流录音与本浏览器 archive、实时转录、中断恢复、安全收束和事实展示；Android Chrome 为完整主设备，iPhone Safari 延期；项目管理/完整回顾后置 | `SPEC-DEV-005R`、`DEV-005R1`、`DEV-005R2C` 已 DONE；`DEV-005R2` REVIEW，`DEV-005R3/4` 继续等待依赖 | 原子 start、capture generation、同一 audio object、archive/delivery 分离、统一 snapshot、既有 finalization | R1 final head `c19a295`、CI `31245403822`；R2C final head `ae07747`、CI `31246011913`；R2 本地 format/lint/typecheck/build、unit 32 files/168 tests、integration 7 files/41 tests、auth 3 files/13 tests、普通 Chromium 7/7、auth Chromium 4/4、smoke 与 migration/status PASS；Android Chrome 真机 5–10 分钟及生命周期矩阵因无设备未验证 | REV-020/022 定向复审 PASS；R2 等待项目负责人 GitHub 审查；CON-020/021 继续开放 | 执行中 |
