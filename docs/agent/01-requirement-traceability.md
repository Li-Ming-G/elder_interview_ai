...
| REQ-003 | `01` §6；`04` §4.7/4.9；`05` §5；`06` §4-10；ADR-006/018/019 | 实时 ASR、确定态转录与说话人映射 | DEV-004A 已合并；DEV-004B1 服务端候选进入 REVIEW；B2/C 待后续 | B1 静态 `/ws/interviews`、join/PCM/ACK/恢复正式契约；无公开文字注入 | A：最终 CI `30887031030` PASS；B1 本地 unit 18 files/87 tests、format/lint/typecheck/build/audit PASS，真实 WS/PostgreSQL 与 CI 待执行；B2 待 Chromium | REV-012 PASS；REV-013 待 GitHub head/CI/项目负责人结论 | IN_PROGRESS |
