...
| SPEC-ASR-PROVIDER-001 | 腾讯实时 ASR V2 供应商接入契约冻结 | 正式契约 Agent | REVIEW | DISC-ASR-PROVIDER-001 DONE；DEV-004/005 seam DONE | [任务卡](tasks/SPEC-ASR-PROVIDER-001.md)、[交接](handoffs/SPEC-ASR-PROVIDER-001.md)、ADR-032、CON-027、正式 v2 machine contract | branch `codex/spec-asr-provider-001`；等待 non-Draft PR exact-head CI 与项目负责人手动 GitHub 审查；不得自宣 PASS/DONE |
