...
| DEV-004C2 | 单段/受控批量角色修正与派生失效 seam | 待创建的独立实现任务 | READY | SPEC-DEV-004C PASS、DEV-004C1 PASS | [任务卡](tasks/DEV-004C2.md)、`04` 至 `07`、`09` | C1 前置已成立；复杂批量 UI 仍归后续回顾切片，C2 只实现正式契约内的修正与失效证据 seam |
