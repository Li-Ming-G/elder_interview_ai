...
| DEV-004 | 实时 ASR 与说话人映射（父任务） | 总控 Agent | IN_PROGRESS | DEV-003 | [父任务卡](tasks/DEV-004.md)、ADR-018/019/025 | DEV-004A/B1/B2 与 SPEC-DEV-004C 已通过；C1 READY、C2 尚未实现；父任务不提前关闭 |
...
| DEV-004C1 | 正式流说话人确认与可信角色门禁 | Codex DEV-004C1 实现任务 | IN_PROGRESS | SPEC-DEV-004C PASS | [任务卡](tasks/DEV-004C1.md)、`01`、`03` 至 `07`、`09` | 分支 `codex/dev-004c1-speaker-calibration` 实现中；不得创建第二录音/ASR 流或把 provider 自动角色冒充用户确认 |
