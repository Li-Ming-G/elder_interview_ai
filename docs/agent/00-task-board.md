...
| DEV-004 | 实时 ASR 与说话人映射（父任务） | 总控 Agent | IN_PROGRESS | DEV-003 | [父任务卡](tasks/DEV-004.md)、ADR-018/019/025 | DEV-004A/B1/B2/C1 与 SPEC-DEV-004C 已通过；C2 READY、尚未实现；父任务不提前关闭 |
...
| DEV-004C2 | 单段/受控批量角色修正与派生失效 seam | 独立实现任务 `019fe614-9503-7891-a1d3-8708c60166e0` | IN_PROGRESS | SPEC-DEV-004C PASS、DEV-004C1 PASS | [任务卡](tasks/DEV-004C2.md)、`04` 至 `07`、`09`、CON-023 | 已从 main@`74eda41` 启动独立 worktree；复杂批量 UI 与 DEV-006 consumer 禁止提前实现。当前 deletion 子系统不存在，C2 不造半模型；未来 DEV-008 必须回接 scope guard |
