...
| SPEC-QUESTION-DIRECTOR-001 | 自由生成下一问、模型 Context 与 Prompt 契约纠偏 | 总控 Agent | REVIEW | DEV-006/007A DONE、项目负责人授权纠偏 | [任务卡](tasks/SPEC-QUESTION-DIRECTOR-001.md)、[交接](handoffs/SPEC-QUESTION-DIRECTOR-001.md)、[PR #26](https://github.com/Li-Ming-G/elder_interview_ai/pull/26)、ADR-031、CON-026、REV-037 | old head `0a75b170` REQUEST_CHANGES/P1=4；定向统一两份 Schema、基础硬校验、同输入 retry 与 seen/declared 归档。项目负责人新 exact-head PASS/merge 前不得解锁 DEV-007B |
| DEV-007 | 结构化访谈导演与 AI 下一问（父任务） | 待分配 | BLOCKED | SPEC-QUESTION-DIRECTOR-001 PASS/merge、DEV-007A/B 完成 | [父任务卡](tasks/DEV-007.md)、ADR-027-031、CON-026 | 父任务不直接开工；A/B 均完成并经聚合验收前不转 DONE |
...
| DEV-007B | 结构化访谈导演与工作台集成 | 待分配 | BLOCKED | SPEC-QUESTION-DIRECTOR-001 PASS/merge、DEV-007A PASS、DEV-006 DONE | [任务卡](tasks/DEV-007B.md)、[提示词](prompts/DEV-007B.md)、QuestionEvidence/current-memory seam、`09` §7.6-7.7、PR #25 old RC | PR #25 的题库白名单实现保持 REQUEST_CHANGES；新契约 PASS 后以 v2 分支/PR 重写 director/context/candidate，保留可移植的 API/WS/history/UI |
