...
| SPEC-DEV-004C | 正式流说话人校准、修正与下游可信角色契约 | 总控 Agent | REVIEW | DISC-004C DONE | [任务卡](tasks/SPEC-DEV-004C.md)、ADR-025、CON-014、REV-027、PR #17 | 首轮 head `6983ee0` REQUEST_CHANGES（P1=3）；正在定向修订不可变边界、下游 SPEC 门禁和统一 snapshot，CON-014 保持 OPEN |
