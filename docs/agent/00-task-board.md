...
| `PFC-07-FULL-FLOW-E2E` | `REVIEW` | PR #133 exact head `2749ffd719b4c9544caa97acaee5337072280202`; required exact-head verify CI is pending or missing; Dispatcher waiting | [`tasks/PFC-07-FULL-FLOW-E2E.md`](tasks/PFC-07-FULL-FLOW-E2E.md) | `luna-high` | `133` | `null` |
...
`PFC-06-ERROR-AUTH-RESILIENCE` is persisted `DONE` after accepted merge and exact-current-main verification. `PFC-07-FULL-FLOW-E2E` is persisted `REVIEW` on PR #133 at exact head `2749ffd719b4c9544caa97acaee5337072280202` and is waiting for required exact-head verify CI.
