...
| `CKPT-A-WEB-CWD-01` | `BLOCKED` | `CKPT-A-LEGACY-PREPARE-BRIDGE-01` DONE; PR #125 merged from exact head `60cdce838394467379254890d3b2536cca3383c6` into main `3ce74646b0070c044a1cfec72950170d3f3c6561`; exact-current-main CI run `33297492383` failed (`MAIN_VERIFY_FAILED`) | [`tasks/CKPT-A-WEB-CWD-01.md`](tasks/CKPT-A-WEB-CWD-01.md) | `luna-high` | `125` | `null` |
