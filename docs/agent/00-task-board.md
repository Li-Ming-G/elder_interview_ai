...
| SPEC-DEV-006 | 后台当前记忆、问题证据与跨会话消费契约 | 独立契约任务 `019fe70b-103e-7ff2-b916-9a9bcb0ea1c0` | REVIEW | DEV-004C1/C2 DONE、DISC-006 DONE、CON-024 RESOLVED | [任务卡](tasks/SPEC-DEV-006.md)、[交接](handoffs/SPEC-DEV-006.md)、ADR-027、`04/05/07/08/09/10` | 审查候选已冻结 scope+membership、claim/resolution、snapshot/eligibility/visibility、actual-question 单一 owner、两阶段并发与删除失败关闭；等待非 Draft PR exact head/CI 上的项目负责人手动审查，不得自行 PASS/DONE |
