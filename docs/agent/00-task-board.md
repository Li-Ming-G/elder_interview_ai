...
| SPEC-QUESTION-JOURNEY-001 | 陌生访谈旅程、双题库与有据轻调契约 | 专项契约 Agent | REVIEW | DEV-006 DONE、SPEC-AI-QUESTION-001 DONE、项目负责人确认产品方向 | [任务卡](tasks/SPEC-QUESTION-JOURNEY-001.md)、[PR #23](https://github.com/Li-Ming-G/elder_interview_ai/pull/23)、`01/03/04/05/07/08/09/10`、ADR-030 候选、CON-025、REV-034 | old head `0f3034d` 正式 REQUEST_CHANGES（P0=0/P1=3）永久保留；14 列/purpose、条件 v1、journey policy 与 adaptation reason 定向修复候选等待负责人 exact-head 复审。本任务不得自行 PASS/DONE，CON-025 保持 OPEN |
| DEV-007 | 题库约束的 AI 下一问（父任务） | 待分配 | BLOCKED | SPEC-QUESTION-JOURNEY-001 PASS、DEV-007A/B 完成 | [父任务卡](tasks/DEV-007.md)、ADR-027-030、CON-025 | 父任务不直接开工；A/B 均完成并经聚合验收前不转 DONE |
| DEV-007A | 题库基础设施、旅程阶段与确定性选择 seam | 待分配 | BLOCKED | SPEC-QUESTION-JOURNEY-001 项目负责人 GitHub PASS | [任务卡](tasks/DEV-007A.md)、[提示词](prompts/DEV-007A.md)、`04` §4.35A-4.35B、`05` §3.9.0、`09` §7.7 | SPEC 候选仍在 REVIEW；不得提前实现、创建实现分支或把 fixture 当产品内容 |
| DEV-007B | AI 题库选择、有据轻调与工作台集成 | 待分配 | BLOCKED | SPEC-QUESTION-JOURNEY-001 PASS、DEV-007A PASS、DEV-006 DONE | [任务卡](tasks/DEV-007B.md)、[提示词](prompts/DEV-007B.md)、QuestionEvidence/current-memory seam、`09` §7.6-7.7 | 等 A 提供稳定 seam；不得自由生成、复制 question history 或绕过正式题库导入门禁 |
