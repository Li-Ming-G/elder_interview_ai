...
| SPEC-AI-QUESTION-001 | 单问题自动更新、手动下一问与展示历史契约 | AI/后端契约 Agent（当前独立 worktree） | REVIEW | SPEC-FE-001 DONE、SPEC-DEV-006 DONE、DISC-AI-QUESTION-001 DONE | [任务卡](tasks/SPEC-AI-QUESTION-001.md)、[执行提示词](prompts/SPEC-AI-QUESTION-001.md)、[交接](handoffs/SPEC-AI-QUESTION-001.md)、ADR-027/028/029、CON-018 | 契约候选已冻结 publication revision/display sequence、manual intent fence、REST canonical + 无正文 WS、稳定 cursor、节流/相似度/滞回和安全投影；等待非 Draft PR exact-head CI 与项目负责人 GitHub 手动审查，保持 REVIEW，不自行 PASS/DONE |
