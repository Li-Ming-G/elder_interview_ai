...
| SPEC-QUESTION-JOURNEY-001 | 陌生访谈旅程、双题库与有据轻调契约 | 专项契约 Agent | REVIEW | DEV-006 DONE、SPEC-AI-QUESTION-001 DONE、项目负责人确认产品方向 | [任务卡](tasks/SPEC-QUESTION-JOURNEY-001.md)、`01/03/04/05/07/08/09/10`、ADR-030 候选、CON-025 | docs-only 候选等待项目负责人对非 Draft PR exact final head 手动审查；本任务不得自行 PASS/DONE，CON-025 保持 OPEN |
