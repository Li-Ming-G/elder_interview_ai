...
| `PFC-07-FULL-FLOW-E2E` | `IN_PROGRESS` | PR #133 repaired exact head `c78df049041b175c868bc8907746a4579dd82186`; required CI run `33601510234` failed at the primary browser journey's speaker calibration transition; same-task/same-PR repair required | [`tasks/PFC-07-FULL-FLOW-E2E.md`](tasks/PFC-07-FULL-FLOW-E2E.md) | `luna-high` | `133` | `null` |
