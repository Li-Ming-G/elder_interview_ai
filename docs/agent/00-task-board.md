...
| DEV-005R4 | 首次访谈真实采集纵向验收与收口 | 待创建的集成验收任务 | READY | DEV-005R1、DEV-005R2、DEV-005R3 PASS | [任务卡](tasks/DEV-005R4.md)、CON-020、CON-021、CON-022 | 前置已满足；需在桌面与 Android Chrome 完成恢复、安全结束及故障矩阵，项目负责人 PASS 后才可关闭父任务与冲突 |
