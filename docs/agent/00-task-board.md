...
| `PFC-01-NEW-INTENT-TRUTH` | `IN_PROGRESS` | PR #127 at exact head `07621884f0e3a74d9d383046115b88109d8d3059`; current-head Architect REQUEST_CHANGES P1 requires same-task/same-PR repair for active-workflow shadowing and reconciliation-unavailable fail-closed behavior | [`tasks/PFC-01-NEW-INTENT-TRUTH.md`](tasks/PFC-01-NEW-INTENT-TRUTH.md) | `luna-high` | `127` | `PFC-02-PRESTART-DISCARD` |
...
Current active task: `PFC-01-NEW-INTENT-TRUTH` (`IN_PROGRESS`, PR #127). Current-head Architect REQUEST_CHANGES requires bounded same-PR repair so explicit fresh-new cannot shadow an unfinished recovery handle and reconciliation errors fail closed.
