...
| DEV-004B1 | 业务 WebSocket 服务端协议核心 | 后端实时转录实现 Agent（待启动） | READY | DEV-004A、ADR-019 | [任务卡](tasks/DEV-004B1.md)、`05` §5、`06` §4/§9/§11 | 静态 WS、JSON/base64 合成 PCM、单进程短时恢复；不含 Web UI、真实 ASR 或 AudioWorklet |
