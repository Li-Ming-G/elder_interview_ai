...
| SPEC-AI-QUESTION-001 | 单问题自动更新、手动下一问与展示历史契约 | 待分配 | READY | SPEC-FE-001 DONE、SPEC-DEV-006 DONE、DISC-AI-QUESTION-001 DONE | [任务卡](tasks/SPEC-AI-QUESTION-001.md)、[执行提示词](prompts/SPEC-AI-QUESTION-001.md)、ADR-027/028、CON-018 | 冻结自动替换稳定规则、下一个问题幂等、展示历史游标、安全投影、节流、相似度和最终 REST/WS；不得重建 question history 或把曾展示冒充实际问过 |
