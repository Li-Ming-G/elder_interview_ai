...
| DEV-007B | 结构化访谈导演与工作台集成 | 待分配 | READY | SPEC-QUESTION-DIRECTOR-001 PASS/merge、DEV-007A PASS、DEV-006 DONE | [任务卡](tasks/DEV-007B.md)、[提示词](prompts/DEV-007B.md)、QuestionEvidence/current-memory seam、`09` §7.6-7.7、PR #25 old RC | 技术前置已满足，但尚未开工；必须从 main 新建 v2 分支/PR。PR #25 的题库白名单实现保持 REQUEST_CHANGES，不得合并，只可选择性移植契约中立代码 |
