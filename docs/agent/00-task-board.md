...
| DISC-ASR-PROVIDER-001 | 真实流式 ASR 首版范围与供应商选择 | 项目负责人 + 独立可见讨论任务 | IN_PROGRESS | DEV-004/005 内部 seam DONE；真实 LLM 接入前置 | 独立任务窗口 `client-new-thread:a29da440-aace-406d-b631-fb85b9870f80`、`06`、`09`、HARDEN-ASR-001 | 先确定语言/方言、数据处理地区与保留政策、单声道双人临时 speaker label 门槛，再比较官方实时能力与做虚构短音频试验；本讨论不实现 provider，不把 gap/backfill 并入首版 |
