...
| DEV-007B | AI 题库选择、有据轻调与工作台集成 | 待分配 | READY | SPEC-QUESTION-JOURNEY-001 PASS、DEV-007A PASS、DEV-006 DONE | [任务卡](tasks/DEV-007B.md)、[提示词](prompts/DEV-007B.md)、QuestionEvidence/current-memory seam、`09` §7.6-7.7 | A 已提供稳定 seam；B 可用 synthetic fixture 开发内部链路，不得自由生成、复制 question history 或把 fixture 冒充正式题库 |
