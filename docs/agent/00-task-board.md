...
| SPEC-DEV-006 | 后台当前记忆、问题证据与跨会话消费契约 | 待分配的独立契约任务 | READY | DEV-004C1/C2 DONE、DISC-006 DONE、CON-024 RESOLVED | [任务卡](tasks/SPEC-DEV-006.md)、[启动提示词](prompts/SPEC-DEV-006.md)、ADR-026、`04/05/07/08/09/10` | 冻结 current memory、逐 session watermark/provenance、displayed snapshot/future eligibility、actual asked、过程记录、删除与模块所有权；项目负责人 GitHub PASS 前 DEV-006 不得开工 |
...
| DEV-006 | 后台结构化长期记忆最小纵向链路 | 待分配 | BLOCKED | DISC-006 DONE、DEV-004C1/C2 DONE、SPEC-DEV-006 PASS | [任务卡](tasks/DEV-006.md)、ADR-026、`04/05/07/08/09` | 等待 SPEC-DEV-006 项目负责人 GitHub PASS；补转录不是前置，不做记忆 UI/真实供应商，不得自行发明跨 session 水位、actual-question 或 stale 模型 |
