...
| `PFC-07-FULL-FLOW-E2E` | `IN_PROGRESS` | PR #133 repaired exact head `4e633008327510b675f9e7fe41205260e3ebfb4f`; required CI run `33600038746` failed at the primary browser journey; same-task/same-PR repair required | [`tasks/PFC-07-FULL-FLOW-E2E.md`](tasks/PFC-07-FULL-FLOW-E2E.md) | `luna-high` | `133` | `null` |
