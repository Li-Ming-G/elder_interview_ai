...
| SPEC-AI-QUESTION-001 | 单问题自动更新、手动下一问与展示历史契约 | AI/后端契约 Agent（当前独立 worktree） | REVIEW | SPEC-FE-001 DONE、SPEC-DEV-006 DONE、DISC-AI-QUESTION-001 DONE | [任务卡](tasks/SPEC-AI-QUESTION-001.md)、[执行提示词](prompts/SPEC-AI-QUESTION-001.md)、[交接](handoffs/SPEC-AI-QUESTION-001.md)、[PR #21](https://github.com/Li-Ming-G/elder_interview_ai/pull/21)、ADR-027/028/029、CON-018 | 契约候选已冻结 publication revision/display sequence、manual intent fence、REST canonical + 无正文 WS、稳定 cursor、节流/相似度/滞回和安全投影；等待非 Draft PR exact-head CI 与项目负责人 GitHub 手动审查，保持 REVIEW，不自行 PASS/DONE |
...
| SPEC-DEV-006 | 后台当前记忆、问题证据与跨会话消费契约 | 独立契约任务 `019fe70b-103e-7ff2-b916-9a9bcb0ea1c0` | DONE | DEV-004C1/C2 DONE、DISC-006 DONE、CON-024 RESOLVED | [任务卡](tasks/SPEC-DEV-006.md)、[交接](handoffs/SPEC-DEV-006.md)、[PR #20](https://github.com/Li-Ming-G/elder_interview_ai/pull/20)、ADR-027、REV-031 | 项目负责人对 final head `4759633`、CI `31326717132` 定向复审 PASS，P0/P1=0；merge `6289c87`。旧 head REQUEST_CHANGES 永久保留；CON-018/023 继续 OPEN |
...
| DEV-006 | 后台结构化长期记忆最小纵向链路 | 待分配 | READY | DISC-006 DONE、DEV-004C1/C2 DONE、SPEC-DEV-006 PASS/merge | [任务卡](tasks/DEV-006.md)、ADR-026/027、`04/05/07/08/09/10` | 实现 shared QuestionEvidenceModule/actual catalog 与后台 current memory；DEV-007 只消费 seam。CON-023 继续 NOT IMPLEMENTED/NOT VERIFIED，不得用 no-op guard 冒充删除覆盖 |
