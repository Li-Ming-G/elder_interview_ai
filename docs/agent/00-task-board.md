...
| DEV-006 | 后台结构化长期记忆最小纵向链路 | 独立实现任务 `019fe9e5-2a04-79e0-9e49-5f99ca21f648` | REVIEW | DISC-006 DONE、DEV-004C1/C2 DONE、SPEC-DEV-006 PASS/merge | [任务卡](tasks/DEV-006.md)、[交接](handoffs/DEV-006.md)、[PR #22](https://github.com/Li-Ming-G/elder_interview_ai/pull/22)、ADR-026/027、REV-033 | old head `d507350` / CI `31357613683` 正式 REQUEST_CHANGES（P0=0/P1=8）永久保留；八项限域修复候选已完成本地验证，等待新 exact-head CI 和项目负责人 GitHub 手动定向复审。不得自行 PASS/DONE/merge；CON-023 继续 OPEN / NOT IMPLEMENTED / NOT VERIFIED，生产 boundary/deletion reader 均 fail-closed |
| DEV-007 | AI 追问引擎 | 待分配 | BLOCKED | DEV-006 PASS、SPEC-AI-QUESTION-001 DONE | `05`、`07`、`09`、ADR-029 | 单问题契约前置已满足，只等待 DEV-006 提供 current memory、QuestionEvidence 与 actual-asked seam；旧采用/已问/忽略生命周期不得实现 |
