...
| DISC-004C | 说话人校准、修正与下游消费边界讨论 | 待创建的独立产品讨论任务 | READY | DEV-004A/B1/B2、DEV-005 DONE | [讨论任务卡](tasks/DISC-004C.md)、[讨论提示词](prompts/DISC-004C.md)、CON-014 | 只形成候选决定包；总控验收并写回正式规范前不得启动 DEV-004C 实现 |
