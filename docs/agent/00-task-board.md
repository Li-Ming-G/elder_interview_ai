...
| `REAL-IDENTITY-01` | `IN_PROGRESS` | Product Owner real-flow cleanup authorization; CPA-05 DONE | [`tasks/REAL-IDENTITY-01.md`](tasks/REAL-IDENTITY-01.md) | `luna-high` | `null` | `REAL-RUNTIME-02` |
...
`REAL-IDENTITY-01` is now `IN_PROGRESS`; `REAL-RUNTIME-02` remains `DEFERRED` until the accepted Dispatcher lifecycle closes the predecessor.
