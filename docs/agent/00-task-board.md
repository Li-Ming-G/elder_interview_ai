...
| DEV-007 | AI 追问引擎 | 待分配 | BLOCKED | DEV-006 DONE、SPEC-AI-QUESTION-001 DONE、CON-025 待产品对齐 | `05`、`07`、`09`、ADR-029、CON-025 | 项目负责人明确要求暂不启动 DEV-007；当前项目与预期存在尚未逐项说明的差异，先完成产品对齐，不创建实现任务或分支 |
