...
| `CKPT-A-WEB-CWD-01` | `DONE` | `CKPT-A-LEGACY-PREPARE-BRIDGE-01` DONE; PR #125 merged from exact head `60cdce838394467379254890d3b2536cca3383c6` into current main `c515d69112d395499ccc02d6176dde092b7cfbea`; exact-current-main CI run `33297942677` SUCCESS; recovered from `MAIN_VERIFY_FAILED` | [`tasks/CKPT-A-WEB-CWD-01.md`](tasks/CKPT-A-WEB-CWD-01.md) | `luna-high` | `125` | `null` |
