...
| DEV-004 | 实时 ASR 与说话人映射（父任务） | 总控 Agent | IN_PROGRESS | DEV-003 | [父任务卡](tasks/DEV-004.md)、ADR-018/019/025 | DEV-004A/B1/B2/C1 与 SPEC-DEV-004C 已通过；C2 已提交 REVIEW 候选、等待 exact-head 复审；父任务不提前关闭 |
...
| DEV-004C2 | 单段/受控批量角色修正与派生失效 seam | 独立实现任务 `019fe614-9503-7891-a1d3-8708c60166e0` | REVIEW | SPEC-DEV-004C PASS、DEV-004C1 PASS | [任务卡](tasks/DEV-004C2.md)、[交接](handoffs/DEV-004C2.md)、`04` 至 `07`、`09`、CON-023 | 核心 producer seam、工作台单段 UI 与本地适用验证已完成，等待 exact final head GitHub 复审。project restricted/deleted 已实现；deletion scope `NOT IMPLEMENTED / NOT VERIFIED`，CON-023 OPEN；复杂批量 UI 与 DEV-006 consumer 未实现 |
