...
| DEV-007A | 题库基础设施、旅程阶段与确定性选择 seam | 待分配 | READY | SPEC-QUESTION-JOURNEY-001 项目负责人 GitHub PASS | [任务卡](tasks/DEV-007A.md)、[提示词](prompts/DEV-007A.md)、`04` §4.35A-4.35B、`05` §3.9.0、`09` §7.7 | 契约前置已通过；只允许以 synthetic fixture 验证内部链路，正式内部试用前必须导入项目负责人题库 |
