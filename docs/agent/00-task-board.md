...
| `PFC-01-NEW-INTENT-TRUTH` | `REVIEW` | PR #127 at exact head `07621884f0e3a74d9d383046115b88109d8d3059`; exact-head CI run `33478639358` attempt 2 SUCCESS | [`tasks/PFC-01-NEW-INTENT-TRUTH.md`](tasks/PFC-01-NEW-INTENT-TRUTH.md) | `luna-high` | `127` | `PFC-02-PRESTART-DISCARD` |
...
Current active task: `PFC-01-NEW-INTENT-TRUTH` (`REVIEW`, PR #127) at exact head `07621884f0e3a74d9d383046115b88109d8d3059`. Exact-head CI run `33478639358` attempt 2 is SUCCESS; external Architect review is required.
