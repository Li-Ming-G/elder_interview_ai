...
| DEV-005R3 | 正式工作台采集、恢复与安全结束体验 | 待创建的前端产品实现任务 | READY | DEV-005R1、DEV-005R2 PASS、DISC-005R-UI DONE | [任务卡](tasks/DEV-005R3.md)、REV-024 | UI 必须使用 impeccable；必须修复服务端已 interrupted 仍显示“进行中”的事实错配，并提供真实恢复/安全结束动作；低音量检测 P2 见 CON-022 |
