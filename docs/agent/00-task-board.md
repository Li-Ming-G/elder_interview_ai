...
| DISC-006 | 结构化长期记忆产品行为讨论 | 项目负责人 + 独立产品讨论任务 | READY | DEV-004C1/C2 DONE | [任务卡](tasks/DISC-006.md)、[讨论提示词](prompts/DISC-006.md)、`01/03/07/09` | 逐项决定最小记忆、候选/确认/冲突、跨会话、失效/重算、降级和验收；讨论只产出候选决定包 |
