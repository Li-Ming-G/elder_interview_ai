...
| DISC-006 | 结构化长期记忆产品行为讨论 | 项目负责人 + 独立产品讨论任务 | BLOCKED | DEV-004C1/C2 DONE | [任务卡](tasks/DISC-006.md)、[讨论提示词](prompts/DISC-006.md)、CON-024、`01/03/07/08/09` | 候选决定包已定稿；仅等待项目负责人裁决已展示问题在硬安全边界命中后是否立即撤下，未裁决前不正式写回或解锁下游 |
| SPEC-DEV-006 | AI 派生结果的角色版本、证据 provenance 与失效消费契约 | 待分配 | BLOCKED | DEV-004C1 PASS、DISC-006 DONE | [任务卡](tasks/SPEC-DEV-006.md)、`04`、`05`、`07`、`09` | DISC-006 定稿后冻结逐 session watermark、跨 session 聚合、job/segment/output 关系、stale/重算失败和查询过滤；项目负责人 PASS 前 DEV-006 不得开工 |
...
| DEV-006 | 结构化长期记忆 | 待分配 | BLOCKED | DISC-006 DONE、DEV-004C1 PASS、SPEC-DEV-006 PASS | `04`、`07`、`09` | 当前先完成 DISC-006 产品定稿，再由 SPEC-DEV-006 冻结 consumer seam；补转录不是前置，不得自行发明单 session revision 或 stale 字段 |
