...
| `CPA-04` | `IN_PROGRESS` | CPA-03 external PASS + merge + main verification; Owner Prompt artifact `22760af1adc5d08f51f5dd3ed0aebca5f3c7d984` | [`tasks/CPA-04.md`](tasks/CPA-04.md) | `luna-high` | `null` | `CPA-05` |
...
`CPA-04` is the sole eligible task after the Owner Prompt artifact gate was satisfied and is now IN_PROGRESS.
