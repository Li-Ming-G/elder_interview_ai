...
| SPEC-AI-QUESTION-001 | 单问题建议与替换契约 | 待分配 | BLOCKED | SPEC-FE-001 DONE、SPEC-DEV-006 项目负责人 PASS 并合并 | [任务卡](tasks/SPEC-AI-QUESTION-001.md) | PR #20 获项目负责人 PASS/merge 前不得提前 READY；后续治理收口才可单独切回 READY |
...
| SPEC-DEV-006 | 后台当前记忆、问题证据与跨会话消费契约 | 独立契约任务 `019fe70b-103e-7ff2-b916-9a9bcb0ea1c0` | REVIEW | DEV-004C1/C2 DONE、DISC-006 DONE、CON-024 RESOLVED | [任务卡](tasks/SPEC-DEV-006.md)、[交接](handoffs/SPEC-DEV-006.md)、[PR #20](https://github.com/Li-Ming-G/elder_interview_ai/pull/20)、ADR-027、`04/05/07/08/09/10` | 项目负责人对旧 head `2b6a5da`（CI `31321844664`）正式 REQUEST_CHANGES（P0=0/P1=3）；定向修复保持 REVIEW，等待新 exact head/CI 的三项复审 |
...
| DEV-006 | 后台结构化长期记忆最小纵向链路 | 待分配 | BLOCKED | DISC-006 DONE、DEV-004C1/C2 DONE、SPEC-DEV-006 PASS | [任务卡](tasks/DEV-006.md)、ADR-026/027、`04/05/07/08/09/10` | 可下发范围已形成但仍等待 SPEC-DEV-006 项目负责人 GitHub PASS；实现 shared QuestionEvidenceModule/actual catalog，DEV-007 只消费 seam；CON-023 继续 NOT IMPLEMENTED/NOT VERIFIED |
