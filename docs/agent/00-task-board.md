...
| DEV-004 | 实时 ASR 与说话人映射（父任务） | 总控 Agent | IN_PROGRESS | DEV-003 | [父任务卡](tasks/DEV-004.md)、ADR-018/019/025 | DEV-004A/B1/B2 已通过；SPEC-DEV-004C 待项目负责人审查，C1/C2 尚未实现；父任务不提前关闭 |
...
| SPEC-DEV-004C | 正式流说话人校准、修正与下游可信角色契约 | 总控 Agent | REVIEW | DISC-004C DONE | [任务卡](tasks/SPEC-DEV-004C.md)、ADR-025、CON-014 | 正式文档候选已写回，等待项目负责人按 GitHub final head 审查；CON-014 保持 OPEN |
| DEV-004C1 | 正式流说话人确认与可信角色门禁 | 待分配 | BLOCKED | SPEC-DEV-004C PASS | [任务卡](tasks/DEV-004C1.md)、`01`、`03` 至 `07`、`09` | 仅在契约项目负责人 PASS 后解锁；不得创建第二录音/ASR 流或把 provider 自动角色冒充用户确认 |
| DEV-004C2 | 单段/受控批量角色修正与派生失效 seam | 待分配 | BLOCKED | SPEC-DEV-004C PASS、DEV-004C1 PASS | [任务卡](tasks/DEV-004C2.md)、`04` 至 `07`、`09` | 等待 C1 流级身份与可信角色事实；复杂批量 UI 仍归后续回顾切片 |
...
| DEV-006 | 结构化长期记忆 | 待分配 | BLOCKED | SPEC-DEV-004C PASS、DEV-004C1 PASS | `04`、`07`、`09` | 等待可信 effective role、控制内容排除和 revision/membership 消费边界可执行；不必等待 DEV-004C2 实际实现 AI 重算 |
