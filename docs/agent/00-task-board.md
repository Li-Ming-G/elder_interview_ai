...
| `PFC-01-NEW-INTENT-TRUTH` | `IN_PROGRESS` | `CKPT-A-FIRST-CAPTURE-GATE-01` DONE; Owner-authorized [`tasks/PRODUCT-FLOW-CLOSURE-01.md`](tasks/PRODUCT-FLOW-CLOSURE-01.md) | [`tasks/PFC-01-NEW-INTENT-TRUTH.md`](tasks/PFC-01-NEW-INTENT-TRUTH.md) | `luna-high` | `null` | `PFC-02-PRESTART-DISCARD` |
...
Current active task: `PFC-01-NEW-INTENT-TRUTH` (`IN_PROGRESS`). It must separate explicit New vs Resume intent and reconcile stale browser workflow state against server authority before recovery.
