...
| SPEC-ASR-PROVIDER-001 | 腾讯实时 ASR V2 供应商接入契约冻结 | 正式契约 Agent | REVIEW | DISC-ASR-PROVIDER-001 DONE；DEV-004/005 seam DONE | [任务卡](tasks/SPEC-ASR-PROVIDER-001.md)、[交接](handoffs/SPEC-ASR-PROVIDER-001.md)、[PR #28](https://github.com/Li-Ming-G/elder_interview_ai/pull/28)、ADR-032、CON-027、正式 v2 machine contract | non-Draft PR OPEN；exact final head/CI 以 GitHub 审查包绑定；等待项目负责人手动审查，不得自宣 PASS/DONE |
