...
| SPEC-QUESTION-DIRECTOR-001 | 自由生成下一问、模型 Context 与 Prompt 契约纠偏 | 总控 Agent | REVIEW | DEV-006/007A DONE、项目负责人授权纠偏 | [任务卡](tasks/SPEC-QUESTION-DIRECTOR-001.md)、[交接](handoffs/SPEC-QUESTION-DIRECTOR-001.md)、[PR #26](https://github.com/Li-Ming-G/elder_interview_ai/pull/26)、ADR-031、CON-026 | docs-only 候选；题库改为 0..N 可选参考，单次结构化模型自由生成。项目负责人 exact-head PASS/merge 前不得解锁 DEV-007B |
