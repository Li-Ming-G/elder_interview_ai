...
| DEV-004 | 实时 ASR 与说话人映射（父任务） | 总控 Agent | IN_PROGRESS | DEV-003 | [父任务卡](tasks/DEV-004.md)、ADR-018/019/025 | DEV-004A/B1/B2 与 SPEC-DEV-004C 已通过；C1 REVIEW、C2 尚未实现；父任务不提前关闭 |
...
| DEV-004C1 | 正式流说话人确认与可信角色门禁 | Codex DEV-004C1 实现任务 | REVIEW | SPEC-DEV-004C PASS | [任务卡](tasks/DEV-004C1.md)、[交接](handoffs/DEV-004C1.md)、PR #18、`01`、`03` 至 `07`、`09` | 项目负责人对旧 exact head `4d18bcf5826aacad97494342d965b9a28d538497` 正式 `REQUEST_CHANGES`（P0=0、P1=3）；定向修复 commit `87d725c` 已闭合三项 P1，本地全门禁通过；仍为 REVIEW，等待新 exact-head CI 与项目负责人手动复审，不得自行 PASS/DONE |
