...
`CPA-04` is DONE after Architect PASS, merge, and successful main verification. `CPA-05` is now in REVIEW on PR #111 after bounded repair; external Architect exact-head review is required.
