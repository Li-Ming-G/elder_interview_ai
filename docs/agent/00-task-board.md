...
| DEV-002 | 最小项目、服务信息、授权与会话 | 后端业务 Agent（dev002_min_project_consent） | BLOCKED | DEV-001A、DEV-001B 内部候选 seam | [任务卡](tasks/DEV-002.md)、`1085ae6` | 合同中立访问/start 策略已提交；CON-009 阻塞迁移、授权/assignment/API |
