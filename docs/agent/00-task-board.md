...
| DEV-003B | 服务端原始分片、幂等与 manifest | 后端音频实现 Agent（dev003b_audio_backend） | REVIEW | DEV-002 会话 seam、DEV-003A 上传队列 seam | [任务卡](tasks/DEV-003B.md)、ADR-016、`134be76`、unit 48/48、GitHub PR #1 | 本地 PostgreSQL/Docker 不可用；等待 GitHub CI 数据库证据和项目负责人审查，不得标 DONE |
