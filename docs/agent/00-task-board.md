...
| DEV-004A | 确定态转录证据核心与供应商中立适配器 | 后端转录实现 Agent（`dev004a_backend_impl`） | IN_PROGRESS | DEV-003、ADR-018、CON-015/016 | [任务卡](tasks/DEV-004A.md)、`04` 至 `06` | 仅限虚构文本、内部 fake 和后端存储 seam；CON-014 不阻塞本任务 |
