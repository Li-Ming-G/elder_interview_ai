...
| SPEC-ASR-PROVIDER-001 | 腾讯实时 ASR V2 供应商接入契约冻结 | 正式契约 Agent | REVIEW | DISC-ASR-PROVIDER-001 DONE；DEV-004/005 seam DONE | [任务卡](tasks/SPEC-ASR-PROVIDER-001.md)、[交接](handoffs/SPEC-ASR-PROVIDER-001.md)、[PR #28](https://github.com/Li-Ming-G/elder_interview_ai/pull/28)、ADR-032、REV-039、CON-027、正式 v2 machine contract | old head `8d9922b`、CI `31476068838` 获正式 REQUEST_CHANGES（P0=0/P1=1）；定向冻结跨 attempt sticky completeness，候选等待新 exact-head CI 与项目负责人只复审该 P1；不得自宣 PASS/DONE |
| DEV-ASR-PROVIDER-001 | 腾讯实时 ASR V2 adapter v2 实现与真实验收 | 待分配 | BLOCKED | SPEC-ASR-PROVIDER-001 项目负责人 exact-head PASS | [任务卡](tasks/DEV-ASR-PROVIDER-001.md)、`09` §15、v2 machine contract | 不得在 SPEC 审查前开工；不含第二 provider、gap/backfill、Prisma migration、真实 LLM、真实长者或部署 |
