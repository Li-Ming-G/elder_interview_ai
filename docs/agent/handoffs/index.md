...
SEC-AUTH-PUBLIC-001 的匿名登录失败审计、staging/production 安全 Cookie、会话撤销竞态、Access/应用账号分责、默认直接对端 IP 与部署 adapter 门禁见 [`SEC-AUTH-PUBLIC-001.md`](SEC-AUTH-PUBLIC-001.md) 和 [PR #55](https://github.com/Li-Ming-G/elder_interview_ai/pull/55)。当前仅为 REVIEW 候选；ADR-041 Proposed、CON-008/DEV-001B REVIEW、公网/真实凭据禁令与 SPEC-STAGING-DEPLOY-001 独占部署语义均未改变。
