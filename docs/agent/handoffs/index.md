...
DEV-008B1 的单一 repeat/continuation current-facts owner、next-session 幂等并发、全新 session 隔离、recording reminder start gate、Home unknown/online replay、production policy unavailable 与完整审查历史见 [`DEV-008B1.md`](DEV-008B1.md)、[`REV-050`](../reviews/REV-050.md) 和 [PR #51](https://github.com/Li-Ming-G/elder_interview_ai/pull/51)。accepted head `30975626` 已 PASS 并 merge `6e546853`，main CI `31785578105` attempt 2 SUCCESS；attempt 1 时序 flake 与 old REQUEST_CHANGES 永久保留。治理 closeout 仍待联合收口，本索引不提前改 DONE；真实 policy 与 B2 继续独立阻塞。

SPEC-LLM-PROVIDER-001 的 Vercel AI SDK direct-provider、单 active binding、Prompt draft/candidate/formal、隔离 synthetic 横评、真实 provenance 与 region/secret fail-closed REVIEW 包见 [`SPEC-LLM-PROVIDER-001.md`](SPEC-LLM-PROVIDER-001.md)。accepted exact head `77fb3a8` / CI `31783061076` 已获项目负责人 PASS（P0/P1/P2=0），old `b7ae9a4` REQUEST_CHANGES P1=3 永久保留；因并行 REV-050 占用，治理索引使用 REV-051 canonical alias，不改 accepted contract/schema/fixtures。本交接不包含真实 provider/runtime/密钥/formal v2，latest-main integration 仍待窄复审。
