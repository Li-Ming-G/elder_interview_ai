...
| SPEC-QUESTION-JOURNEY-001 | [任务卡](tasks/SPEC-QUESTION-JOURNEY-001.md)、[候选交接](handoffs/SPEC-QUESTION-JOURNEY-001.md)、[PR #23](https://github.com/Li-Ming-G/elder_interview_ai/pull/23)、ADR-030 候选、CON-025 | 项目负责人 GitHub 手动审查、DEV-007A/B（阻塞） | REVIEW；冻结可进可退旅程、basic/deep 版本化题库、CSV→runtime 分层、许可/fixture 门禁、选择/有据轻调双重 provenance 与 A/B 拆分。exact final head/CI 以 PR 为准；不得自行 PASS/DONE，CON-025 继续 OPEN |
