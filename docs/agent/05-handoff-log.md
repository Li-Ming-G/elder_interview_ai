...
|---|---|---|---|
| SPEC-LLM-PROVIDER-001 | [PR #52](https://github.com/Li-Ming-G/elder_interview_ai/pull/52)、REV-051（branch-local REV-050）、[任务卡](tasks/SPEC-LLM-PROVIDER-001.md)、[交接](handoffs/SPEC-LLM-PROVIDER-001.md)、ADR-040、CON-031、REQ-019 | 项目负责人 latest-main integration 冲突窄复审 | REVIEW / CONTENT PASS；accepted `77fb3a8` / CI `31783061076` 获 PASS（P0/P1/P2=0），old `b7ae9a4` / CI `31769677989` / REQUEST_CHANGES P1=3 永久保留。当前只机械整合 main@`6e546853` 并等待新 exact-head CI/窄复审；不得提前 DONE/merge。真实 provider/model/region/密钥/境外处理未选择，DEV-ASR-PROVIDER-001 未 PASS |
...
| DEV-008B1 | [交接](handoffs/DEV-008B1.md)、[任务卡](tasks/DEV-008B1.md)、[PR #51](https://github.com/Li-Ming-G/elder_interview_ai/pull/51)、REV-050 | 联合治理 closeout | REVIEW / CONTENT PASS；accepted `30975626` / CI `31781577641` 已 merge `6e546853`，main CI `31785578105` attempt 2 SUCCESS。old `efac390d` REQUEST_CHANGES P1=3 与 attempt 1 时序 flake 永久保留；本次 #52 integration 不代做 DONE/closeout。生产 policy unavailable，SPEC-CONSENT-TEXT-POLICY-001 与 B2 仍 BLOCKED |
