...
| DEV-008A3 | [候选交接](handoffs/DEV-008A3.md)、[任务卡](tasks/DEV-008A3.md)、REV-045 | 项目负责人 exact-head 手动审查；父 DEV-008A 后续聚合 | REVIEW；base `4fc46456` / main CI `31599184357` SUCCESS，branch `codex/dev-008a3-local-review`。runtime exact-key、fresh preflight、只读回顾/完整播放、IDB v5/共锁/单事务本机删除候选与完整本地门禁已形成；待非 Draft PR final exact-head CI。不得自行 PASS/DONE/merge；A2/008D/CON-023 不变 |
