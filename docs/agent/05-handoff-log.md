...
| DEV-006 | [实现交接](handoffs/DEV-006.md)、ADR-026/027 | 项目负责人 GitHub 手动审查、DEV-007 | REVIEW；current memory、跨会话 provenance/context、QuestionEvidence/actual catalog 与 retention 基座已提交；不得自行 PASS/DONE/merge。CON-023 删除 producer/read model 仍 `NOT IMPLEMENTED / NOT VERIFIED` |
...
| SPEC-AI-QUESTION-001 | [任务卡](tasks/SPEC-AI-QUESTION-001.md)、[交接](handoffs/SPEC-AI-QUESTION-001.md)、[PR #21](https://github.com/Li-Ming-G/elder_interview_ai/pull/21)、ADR-029、REV-032 | DEV-006、DEV-007 | DONE；final head `af088ed6`、CI `31352681061` attempt 2、项目负责人手动审查 PASS、merge `10fcc5c`。CON-018 RESOLVED；DEV-007 的契约前置已满足，但仍等待 DEV-006 seam |
