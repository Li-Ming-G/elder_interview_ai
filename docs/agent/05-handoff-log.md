...
| SPEC-DEV-008A | [契约交接](handoffs/SPEC-DEV-008A.md)、[任务卡](tasks/SPEC-DEV-008A.md)、ADR-034、`local-audio-archive-v1`、REV-041 | 项目负责人手动 GitHub 定向复审；后续 A1/A2/A3/008D | REVIEW；old head `19604291` / CI `31571463898` REQUEST_CHANGES（P1=3）永久保留。A2 四步权威幂等、逐 session 唯一动作与条件 Schema 正反例已形成定向修复候选；A1/A2/A3/008D 均 BLOCKED；CON-023 继续 OPEN |
