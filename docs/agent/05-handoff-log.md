...
|---|---|---|---|
| SPEC-LLM-PROVIDER-001 | [PR #52](https://github.com/Li-Ming-G/elder_interview_ai/pull/52)、[任务卡](tasks/SPEC-LLM-PROVIDER-001.md)、[交接](handoffs/SPEC-LLM-PROVIDER-001.md)、ADR-040、CON-031、REQ-019 | 项目负责人 exact-head GitHub 手动审查 | REVIEW；candidate docs/shared contract、v2 draft 与 synthetic-v1 已形成，runtime/formal v1 不变。待非 Draft PR exact-head CI SUCCESS 后手动结论；不得自 PASS/DONE/merge。真实 provider/model/region/密钥/境外处理未选择，DEV-ASR-PROVIDER-001 未 PASS |
