...
| SPEC-QUESTION-JOURNEY-001 | [任务卡](tasks/SPEC-QUESTION-JOURNEY-001.md)、[候选交接](handoffs/SPEC-QUESTION-JOURNEY-001.md)、[PR #23](https://github.com/Li-Ming-G/elder_interview_ai/pull/23)、ADR-030 候选、CON-025、REV-034 | 项目负责人定向复审、DEV-007A/B（阻塞） | REVIEW；old head `0f3034d`/CI `31371643597` 正式 REQUEST_CHANGES P1=3 永久保留。新候选逐项响应条件 v1、journey policy、14 列 purpose/adaptation reason；exact final head/CI 以 PR 与最终交接为准。不得自行 PASS/DONE，CON-025 OPEN，DEV-007/007A/007B BLOCKED |
