...
| DEV-008A4 | [候选交接](handoffs/DEV-008A4.md)、[任务卡](tasks/DEV-008A4.md)、[PR #44](https://github.com/Li-Ming-G/elder_interview_ai/pull/44)、ADR-037、REV-047 | 项目负责人新 exact-head GitHub 手动复审 | REVIEW；旧 `f1eea3c` / CI `31666579181` SUCCESS 经用户实测发现刷新后自动收尾、unknown create 与同源回顾缺口，历史永久保留。本轮限域修复 canonical 自动恢复、稳定 identity replay、严格同源有界重投影与既有本机删除 alertdialog；本地 static/unit 339 通过，等待新 exact-head CI 全矩阵。不得 PASS/DONE/merge |
