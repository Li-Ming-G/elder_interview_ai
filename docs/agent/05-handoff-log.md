...
| SPEC-DEV-008A1-ACCESS | [交接](handoffs/SPEC-DEV-008A1-ACCESS.md)、[任务卡](tasks/SPEC-DEV-008A1-ACCESS.md)、ADR-035、CON-028、REV-042 | 已获授权总控 exact-head 手动审查；审查合并后恢复 DEV-008A1 | REVIEW；restricted 最小投影、cursor、普通 reader/evidence-finalization 分层候选已写回；无业务实现。等待非 Draft PR exact-head CI SUCCESS 与总控明确结论，不得自行 PASS/DONE/merge |
