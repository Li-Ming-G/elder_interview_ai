...
|---|---|---|---|
| SPEC-STAGING-DEPLOY-001 | [PR #54](https://github.com/Li-Ming-G/elder_interview_ai/pull/54)、[任务卡](tasks/SPEC-STAGING-DEPLOY-001.md)、[交接](handoffs/SPEC-STAGING-DEPLOY-001.md)、[正式候选](../contracts/staging-deployment-v1.md)、manifest Schema/fixtures、ADR-041、REQ-020 | 项目负责人 new exact-head 定向复审；通过后才交 DEV-STAGING-DEPLOY-001 | REVIEW；old `195c4be2` / CI `31798730203` SUCCESS 正式 REQUEST_CHANGES（P0=0/P1=1/P2=0）永久保留。当前仅修 synthetic/fictional 分类、唯一 `data_mode=synthetic_only` 与入站零业务副作用拒绝；不重做其余设计。未安装 Cloudflare、未请求 token、未部署、未处理真实数据 |
| DEV-STAGING-DEPLOY-001 | [任务卡](tasks/DEV-STAGING-DEPLOY-001.md)、staging contract §12、manifest Schema/fixtures、`09` §20 | 后续独立实现任务 | BLOCKED；等待 SPEC 定向复审 PASS/merge。只允许 Named synthetic staging，DEV 无权改为 real/true；真实来源脱敏数据也须未来独立数据治理决定 |
...
| DEV-LLM-PROVIDER-001 | [任务卡](tasks/DEV-LLM-PROVIDER-001.md)、SPEC-LLM-PROVIDER-001、ADR-040、`09` §19 | 项目负责人、数据治理与后续独立 runtime 实现任务 | BLOCKED；等待 DEV-ASR-PROVIDER-001 正式 PASS、provider/model/region/data policy 选择及 DPA/retention/training/跨境与重授权依据接收。不得安装 SDK/provider package、建立 active binding、索取/注入真实密钥或发送真实内容 |
