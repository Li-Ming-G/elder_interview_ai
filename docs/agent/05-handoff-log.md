...
| SPEC-AI-QUESTION-001 | [任务卡](tasks/SPEC-AI-QUESTION-001.md)、[交接](handoffs/SPEC-AI-QUESTION-001.md)、ADR-029、CON-018 | 项目负责人 GitHub 手动审查、DEV-007 | REVIEW；契约候选已形成，等待非 Draft PR exact final head/CI。执行 Agent 不自行 PASS/DONE、不合并；CON-018 OPEN，DEV-007 BLOCKED |
