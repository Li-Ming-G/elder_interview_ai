...
| DEV-ASR-PROVIDER-001 | [实现交接](handoffs/DEV-ASR-PROVIDER-001.md)、[腾讯支持工单模板](handoffs/DEV-ASR-PROVIDER-001-tencent-support-ticket.md)、[任务卡](tasks/DEV-ASR-PROVIDER-001.md)、[历史 PR #45](https://github.com/Li-Ming-G/elder_interview_ai/pull/45)、ADR-032/033、CON-027 | 项目负责人 / 后续同一正式实现 Agent | REVIEW；旧 `af99d91` 的 provider/replay/桌面/Android 虚构证据永久保留。2026-08-14 closeout 从 `1eb26b2f` 逐路径迁移并修正遗留 speaker label session-wide unique index；新 head unit395、fresh PG integration89、auth23、Chromium27、auth Chromium5、15 migrations、300s R4（296 chunks/两代 stream/双人确认/pending0/manifest complete/sticky degraded）通过。实际账单与负责人 exact-head 审查待完成；新 PR metadata 为准；不得自宣PASS/DONE/merge |
