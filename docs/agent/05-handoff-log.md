...
| DEV-008A4 | [候选交接](handoffs/DEV-008A4.md)、[任务卡](tasks/DEV-008A4.md)、ADR-037、REV-047 | 项目负责人 exact-head GitHub 手动审查 | REVIEW；contract-first 主链路、interim `content_kind`、formal calibration skip、自动收尾、exact complete ACK、回顾重投影与独立完成页已实现。本地 static/build/unit 339 通过；Chromium spawn EPERM 与 Docker/DB 不可用等 exact-head CI 覆盖。待 non-Draft PR/CI，不得 PASS/DONE/merge |
