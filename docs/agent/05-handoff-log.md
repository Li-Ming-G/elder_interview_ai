...
|---|---|---|---|
| SPEC-LLM-PROVIDER-001 | [PR #52](https://github.com/Li-Ming-G/elder_interview_ai/pull/52)、REV-050、[任务卡](tasks/SPEC-LLM-PROVIDER-001.md)、[交接](handoffs/SPEC-LLM-PROVIDER-001.md)、ADR-040、CON-031、REQ-019 | 项目负责人 exact-head GitHub 定向复审 | REVIEW / REQUEST_CHANGES；old `b7ae9a4` / CI `31769677989` / P1=3 永久保留。仅修 semantic membership、四类 provenance、canonical config/warnings；新 exact-head CI SUCCESS 后再复审，不得自 PASS/DONE/merge。真实 provider/model/region/密钥/境外处理未选择，DEV-ASR-PROVIDER-001 未 PASS |
