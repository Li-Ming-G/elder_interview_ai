...
|---|---|---|---|
| SPEC-STAGING-DEPLOY-001 | [任务卡](tasks/SPEC-STAGING-DEPLOY-001.md)、[交接](handoffs/SPEC-STAGING-DEPLOY-001.md)、[正式候选](../contracts/staging-deployment-v1.md)、ADR-041、REQ-020 | 项目负责人 exact-head 审查；通过后才交 DEV-STAGING-DEPLOY-001 | REVIEW；唯一 iteration-coach Correction 已吸收。只完成 docs/contract；未安装 Cloudflare、未请求 token、未部署、未处理真实数据。DEV 保持 BLOCKED，`real_data_allowed=false` |
