...
| SPEC-DEV-006 | [候选交接](handoffs/SPEC-DEV-006.md)、ADR-027、非 Draft PR/exact head/CI 待绑定 | 项目负责人手动审查、DEV-006、SPEC-AI-QUESTION-001/DEV-007 | REVIEW；A-F 契约候选已形成，QuestionEvidenceModule 单一 owner、scope+membership、动态 eligibility、两阶段并发、删除/legacy 默认已冻结。不得自行 PASS/DONE；CON-018/023 继续 OPEN |
