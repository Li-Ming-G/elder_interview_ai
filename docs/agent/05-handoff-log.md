...
| SPEC-DEV-006 | [定向修复交接](handoffs/SPEC-DEV-006.md)、[PR #20](https://github.com/Li-Ming-G/elder_interview_ai/pull/20)、ADR-027、REV-031 | 项目负责人三项定向复审、DEV-006、SPEC-AI-QUESTION-001/DEV-007 | REVIEW；old head `2b6a5da`/CI `31321844664` 正式 REQUEST_CHANGES（P0=0/P1=3）永久保留。候选补齐逐业务输出 derived、retention root/child 和 SPEC-AI BLOCKED；新 exact head/CI 待绑定。CON-018/023 继续 OPEN，不得自行 PASS/DONE |
