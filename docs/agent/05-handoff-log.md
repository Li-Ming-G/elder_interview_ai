...
| SPEC-DEV-008A | [契约交接](handoffs/SPEC-DEV-008A.md)、[任务卡](tasks/SPEC-DEV-008A.md)、ADR-034、`local-audio-archive-v1` | 项目负责人手动 GitHub 审查；后续 A1/A2/A3/008D | REVIEW；统一工作区、新建完整授权入口、最小回顾、本机副本原子删除和任务拆分已形成 docs-only 候选。A1/A2/A3/008D 均 BLOCKED；DEV-007 不作前置；CON-023 继续 OPEN |
