...
MEMORY-T2-T4-RUNTIME-001: [`REV-060`](REV-060.md) permanently records PR #68 old `4bda58c` / CI `32017818045` and initial P1=4, plus `7f5a413` / CI `32021995353` re-review comment `5315170627`: original four findings CLOSED, one adjacent detached-reader P1 OPEN. The profile-strict reader/eligibility fix remains REVIEW pending a new exact-head CI and project-owner re-review; no PASS, DONE or merge is claimed.
