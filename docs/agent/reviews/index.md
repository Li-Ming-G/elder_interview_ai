...
MEMORY-T2-T4-RUNTIME-001: [`REV-060`](REV-060.md) permanently records PR #68 old `4bda58c` / CI `32017818045` and two formal REQUEST_CHANGES comments totaling P0=0/P1=4/P2=0. The concentrated four-P1 fix remains REVIEW pending a new exact-head CI and project-owner re-review; no PASS, DONE or merge is claimed.
