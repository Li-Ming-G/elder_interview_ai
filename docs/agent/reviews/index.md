...
DEV-ASR-PROVIDER-001 的 accepted content `5271b52` / CI `31800257197` / 项目负责人 PASS 永久保留；latest-main integration 另以 [`REV-055`](REV-055.md) 记录，当前保持 REVIEW，等待 new exact-head CI 与授权独立窄复审。
