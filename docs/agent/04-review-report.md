...
| SPEC-DEV-008A3-PREFLIGHT | REV-044 | [PR #37](https://github.com/Li-Ming-G/elder_interview_ai/pull/37) / `codex/spec-dev-008a3-finalization-size` / base `51e2337ea86739e209ad696804de7decbcf7a9df`；final exact head/CI 待绑定 | REVIEW / PENDING | total bytes additive nullable 投影与 ordinary/list/evidence 白名单候选；A3 保持 BLOCKED。等待 exact-head CI SUCCESS 与获授权总控手动审查；不得自行 PASS/DONE/merge |
