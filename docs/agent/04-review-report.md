...
| DEV-008A3 | REV-045 | [PR #40](https://github.com/Li-Ming-G/elder_interview_ai/pull/40) / base `4fc46456869ab01d9880d1aa92e7cd838bf920a8` / final exact head/CI 待绑定 | REVIEW / PENDING | runtime exact-key、fresh preflight、只读转录/完整播放、IDB v5 与原子本机删除候选；本地全量静态、unit、真实 PostgreSQL/API、真实 Chromium 矩阵已通过。等待项目负责人 exact-head 手动审查；执行 Agent 不得自行 PASS/DONE/merge。服务器录音/转录/记忆未删除，CON-023 不变 |
