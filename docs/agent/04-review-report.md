...
| SPEC-REPEAT-INTERVIEW-001 | REV-048 | non-Draft PR / exact head CI 待补 | REVIEW / PENDING | docs/shared-contract 候选；ADR-037/REV-047 已留给 DEV-008A4。执行 Agent 只整理 exact-head 人工审查包，不给出 PASS/DONE，不合并；B1/B2 保持 BLOCKED |
