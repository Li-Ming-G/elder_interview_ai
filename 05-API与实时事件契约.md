...
- 外部 `/health` 只能返回无敏感信息的 liveness；业务 readiness 必须同时证明 DB、storage、migration status、app 与 data permission，未 ready 时返回 503 且禁止新访谈。不得通过 health 暴露版本、路径、secret、账号或数据量。
