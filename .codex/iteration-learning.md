...
- Verification evidence: 独立空 PostgreSQL 13 migrations；unit 41 files/279、integration 13 files/74；typecheck/lint/build/format/diff、通用 Chromium E2E 9/9 PASS。Chromium 1440×900、390×844、320×568 无页面 overflow，current/history/focus 五张截图，44px 按钮，320px 历史三按钮完整，键盘 `:focus-visible=true`。
